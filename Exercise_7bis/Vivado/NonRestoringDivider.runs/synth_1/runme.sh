...
HD_PWD='/home/heinecantor/Desktop/git/ASDi-Homeworks/Exercise_7bis/Vivado/NonRestoringDivider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BoardUnit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BoardUnit.tcl
