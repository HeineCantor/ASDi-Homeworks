...
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { ledDivisionFinished }]; #IO_L10P_T1_D14_14 Sch=led16_g
...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { btnStart }]; #IO_L9P_T1_DQS_14 Sch=btnc
